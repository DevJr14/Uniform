...
namespace Infrastructure.Services.Identity
{
    public class RoleClaimService : IRoleClaimService
    {
        ...
        public async Task<Result<List<RoleClaimResponse>>> GetAllAsync()
        {
            ...
            return await Result<List<RoleClaimResponse>>.FailAsync("No Role Claims Found.");
        }
        ...
        public async Task<Result<string>> SaveAsync(RoleClaimRequest request)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    existingRoleClaim.LastModifiedBy = _currentUserService.UserId;
                    existingRoleClaim.LastModifiedOn = DateTime.Now;
